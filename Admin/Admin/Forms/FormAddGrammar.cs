...
{
    public partial class FormAddGrammar : Form
    {
        public int LessonIndex { get; set; }
        public FormAddGrammar()
        {
            InitializeComponent();
        }
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            Grammar grammar = new Grammar(lessonID, term, definition);
            int add = DataContext.AddGrammar(grammar);
            if (add == 1)
            {
